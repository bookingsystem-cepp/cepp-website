      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <Link href="/">
          <div className="flex flex-row gap-4">
            ...
            <h1 className="text-2xl font-bold text-white">LendingHub</h1>
          </div>
        </Link>
        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  href={"/histories/"+session?.user?.id}
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("histories") &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <button
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm w-full px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
