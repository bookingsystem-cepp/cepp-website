...
const SignIn: React.FC = () => {
  ...
  return (
    <div className="mx-12 my-20 sm:mx-30 md:mx-40 lg:mx-50">
      <h1 className="text-2xl font-bold text-black mb-4">Sign In</h1>
      <div className="rounded-sm border border-stroke bg-white shadow-default ">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              <div className="flex flex-row gap-2 justify-center mb-5.5 ">
                <svg 
                  xmlns="http://www.w3.org/2000/svg" 
                  viewBox="-4 -4 32 32" fill="currentColor" 
                  className="w-8 h-8 text-white rounded-lg bg-blue-500"
                >
                  <path 
                    d="M11.25 4.533A9.707 9.707 0 0 0 6 3a9.735 9.735 0 0 0-3.25.555.75.75 0 0 0-.5.707v14.25a.75.75 0 0 0 1 .707A8.237 8.237 0 0 1 6 18.75c1.995 0 3.823.707 5.25 1.886V4.533ZM12.75 20.636A8.214 8.214 0 0 1 18 18.75c.966 0 1.89.166 2.75.47a.75.75 0 0 0 1-.708V4.262a.75.75 0 0 0-.5-.707A9.735 9.735 0 0 0 18 3a9.707 9.707 0 0 0-5.25 1.533v16.103Z" 
                  />
                </svg>
                <h1 className="text-2xl font-bold text-black">LendingHub</h1>
              </div>

              <p className="2xl:px-20 ">
                Ready to borrow what you need, when you need it? Sign in to LendingHub now and explore our wide range of available items waiting to be borrowed.
              </p>
