...
const Settings = ({ params }: { params: { id: string } }) => {
  ...
  const handleSubmit = () => {
    ...
    axios.put('https://backend.tirk101.online/api/user/edit', dataInfo);
  ...
  return (
    <DefaultLayout>
      <div className="mx-auto max-w-270">
        ...
        <div className="mt-10 gap-8 flex justify-center">
              ...
              <div className="p-7">
                ...
                <div className="mb-5.5">
                  <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                    <div className="w-full sm:w-1/2">
                      <label
                        className="mb-3 block text-md mt-2 font-medium text-black dark:text-white"
                        htmlFor="fullName"
                      >
                        Scores: &nbsp;
                        <span 
